...
class MeetupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meetup" do
    assert_difference('Meetup.count') do
      post meetups_url, params: { meetup: { art: @meetup.art, details: @meetup.details, ort: @meetup.ort, zeit: @meetup.zeit } }
    end
  ...
  test "should update meetup" do
    patch meetup_url(@meetup), params: { meetup: { art: @meetup.art, details: @meetup.details, ort: @meetup.ort, zeit: @meetup.zeit } }
